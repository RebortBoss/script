...
insert /* +append parallel(nm 16)*/ into zdd_curt_tmp_data nologging  select * from zdd_curt_tmp_1 NM where UPDATE_TIME>=TO_DATE('$pd','yyyymmddhh24miss') and UPDATE_TIME <TO_DATE('$nd','yyyymmddhh24miss');
commit;
exit;
EOF
