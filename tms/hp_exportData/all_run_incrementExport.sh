...
echo $nextPoint
$BP/increment_export.sh ${TS} tms_mail_monitor_info create_time ${prePoint} ${nextPoint}
...
echo $nextPost
$BP/increment_export.sh ${TS} TMS_MAIL_POSTING_INFO INSERT_TIME ${prePost} ${nextPost} 'posting_date=trunc(sysdate)'
